...
class MarketIntelligence(PlayerEngine):
    ...
    def process(self, player):
        ...
        result = self.evaluate_market(player)
...
if __name__ == "__main__":
    ...
    print(
        "MARKET INTELLIGENCE ENGINE TEST"
    )
    ...
    print(
        f"Market score : "
        f"{result['market_score']}"
    )

    print(
        f"Market level : "
        f"{result['market_level']}"
    )
    ...
    for reason in result["market_reasons"]:
